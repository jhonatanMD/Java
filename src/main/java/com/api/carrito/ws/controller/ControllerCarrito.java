...
public class ControllerCarrito {
    ...
    public List<ClienteEntity> find(){
        return serviceCliente.findAllClientes();
    }


    @GetMapping("/findByCliente/{id}")
    public ClienteEntity findById(@PathVariable("id") int id ){
    ...
    public ProductoEntity saveProducto(@PathVariable("idProd") int idProd ,@RequestBody ProductoEntity producto){
        producto.setIdProducto(idProd);
        return serviceProducto.updProducto(producto);
    }

    @PostMapping("/dltProducto/{idProd}")
    public void saveProducto(@PathVariable("idProd") int idProd ){
    ...
    public List<VentaEntity> findAllVenta () {
    	
    	return serviceVenta.findAll();
    }
    
    @GetMapping("/getDetalleVenta/{idVenta}")     
    public DtoDetalleVenta getDetalleVenta(@PathVariable("idVenta") int idVenta){

        return  serviceDetalleVenta.findDetalleVenta(idVenta);
    }

    @PostMapping("/saveDetalleVenta")
    public DetalleVentaEntity saveDetalleVetan(@RequestBody DetalleVentaEntity detalle ){
